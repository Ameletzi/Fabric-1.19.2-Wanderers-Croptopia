...
public class ModItems {
    ...
    public static final Item PEPPERONI_MUSHROOM_PIZZA = registerItem("pepperoni_mushroom_pizza",
            new Item(new FabricItemSettings().group(ModItemGroup.WANDERERS_MENU).food(ModFoodComponents.PEPPERONI_MUSHROOM_PIZZA)));
    public static final Item BATTER = registerItem("batter",
            new Item(new FabricItemSettings().group(ModItemGroup.WANDERERS_MENU).food(ModFoodComponents.BATTER)));
